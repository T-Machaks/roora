...
export async function updateEventSettings(formData: FormData) {
  ...
  const parsed = eventSettingsSchema.safeParse({
    ...
    mainVenueMapUrl: formData.get("mainVenueMapUrl") || undefined,
    mainVenueLat: formData.get("mainVenueLat") || undefined,
    mainVenueLng: formData.get("mainVenueLng") || undefined,
    ...
    afterVenueMapUrl: formData.get("afterVenueMapUrl") || undefined,
    afterVenueLat: formData.get("afterVenueLat") || undefined,
    afterVenueLng: formData.get("afterVenueLng") || undefined,
  ...
  await db.eventSettings.update({
    ...
    data: {
      ...
      mainVenueMapUrl: d.mainVenueMapUrl || null,
      mainVenueLat: d.mainVenueLat ?? null,
      mainVenueLng: d.mainVenueLng ?? null,
      ...
      afterVenueMapUrl: d.afterVenueMapUrl || null,
      afterVenueLat: d.afterVenueLat ?? null,
      afterVenueLng: d.afterVenueLng ?? null,
